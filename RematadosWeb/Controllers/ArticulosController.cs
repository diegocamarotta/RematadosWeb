...
namespace RematadosWeb.Controllers
{
    public class ArticulosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nombre,Descripcion,Precio,Estado,Categoria")] Articulo articulo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Nombre,Descripcion,Precio,Estado,Categoria")] Articulo articulo)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ArticuloExists(articulo.Nombre))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Articulos.Any(e => e.Nombre == id);
        }
    }
}
